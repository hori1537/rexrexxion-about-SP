...
model = Sequential()
model.add(Dense(DATA_SIZE_DENS, input_dim=62, activation='relu'))
...
model.save('C:\Deeplearning/model_DENS_' +str(score[0]) + '.h5')
...
print('C:\Deeplearning/model_DENS_' +str(score[0]) + '.h5')
